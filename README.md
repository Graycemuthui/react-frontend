...
- This project entails the frontend for the hello rails backend which has been connected with an api.
-  Here is a link to the backend repo [link](https://github.com/Graycemuthui/Hello-rails-back-end)
